...
==============================================================================================================================================
 * Name        : mine1.c
 * Author      : Pooja Pol (S.Y.Btech in Computer Engineering from CoEP)
 * Description : Console version of the snake game for GNU/Linux
 * Copyright (C) Pooja Pol ID : polpooja5297@gmail.com
 *
...
// now print all the menu items and highlight the first one
	...
	while(1){ 
		...
		if(ch == 10 && l == 0) {  /*the menu for the levels*/
			...
			else if(ex == 1) {			// when you win the game
...
void usage() {
	...
	printf("1. Game should be run as ./project score.txt.\n");
	printf("2. Select the required option in the menu.\n");
	printf("3. Next choose the game difficulty of your choice.\n");
	printf("4. Choose option 2 in the main menu to learn the instructions to play the game.\n");
	printf("5. After each game is over, you can easily view high scores by following comments on the pages.\n");
	printf("6. You can press the key q to quit at any point in the game\n");
}
